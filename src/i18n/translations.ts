...
export const TRANSLATIONS: Record<Language, Translations> = {
  ua: {
    ...
    heroDesc: 'Обирайте готові комплексні пакети під ключ, SMM, маркетинг, продюсування онлайн курсів, веб-розробку, відео або автоматизацію. Калькулятор миттєво порахує кошторис та передасть вашу заявку менеджеру.',
    ...
    categoriesSummaryPill: '8 напрямків • Комплекс • SMM • Маркетинг • Курси • Веб • Відео • Автоматизація • Комікси',
    categoriesBadge: '8 напрямків • Комплекс • SMM • Маркетинг • Курси • Веб • Відео • Автоматизація • Комікси',
  ...
  en: {
    ...
    appSubheader: 'All-in-One Packages, SMM, Marketing, Courses, Web, Video, Automation & Comics',
    ...
    heroDesc: 'Choose comprehensive turnkey packages, SMM, marketing, course production, web development, video or automation. Instant calculation and hands off your request directly to our manager.',
    ...
    categoriesSummaryPill: '8 Categories • Turnkey • SMM • Marketing • Courses • Web • Video • Automation • Comics',
    categoriesBadge: '8 Categories • Turnkey • SMM • Marketing • Courses • Web • Video • Automation • Comics',
  ...
  nl: {
    ...
    appSubheader: 'All-in-One Pakketten, SMM, Marketing, Cursussen, Web, Video, Automatisering & Strips',
    ...
    heroDesc: 'Kies complete all-in-one pakketten, SMM, marketing, cursusproductie, webontwikkeling, video of automatisering. Directe berekening en stuurt uw aanvraag direct door naar de manager.',
    ...
    categoriesSummaryPill: '8 Categorieën • Totaalpakketten • SMM • Marketing • Cursussen • Web • Video • Automatisering • Strips',
    categoriesBadge: '8 Categorieën • Totaalpakketten • SMM • Marketing • Cursussen • Web • Video • Automatisering • Strips',
  ...
  ru: {
    ...
    appSubheader: 'Комплексные пакеты, SMM, маркетинг, курсы, веб, видео, автоматизация, комиксы',
    ...
    heroDesc: 'Выбирайте комплексные пакеты под ключ, SMM, маркетинг, продюсирование онлайн-курсов, веб-разработку, видео или автоматизацию. Мгновенный расчет и передача вашей заявки менеджеру.',
    ...
    categoriesSummaryPill: '8 направлений • Комплекс • SMM • Маркетинг • Курсы • Веб • Видео • Автоматизация • Комиксы',
    categoriesBadge: '8 направлений • Комплекс • SMM • Маркетинг • Курсы • Веб • Видео • Автоматизация • Комиксы',
